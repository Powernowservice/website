...
export const metadata = pageMetadata({
  ...
  description: "Power Now Service is a North Houston electrical company focused on load bank repair, critical-power systems, and evidence-led field service.",
  path: "/about",
});
